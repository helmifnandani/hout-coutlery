...
const page = () => {
    return (
        <div>
            <div className="aspect-3x2 md:aspect-4x1 relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen">
                <Image
                    src={banner1}
                    fill
                    placeholder="blur"
            ...
            <div className="px-20 py-10">
                <h2
                    className={`${palatino.className} text-secondary-m text-primary-700`}
                >
                    Online Store
                </h2>
                <p className="mb-6 text-body-xl text-primary-700">
                ...
                <p className="mb-6 text-body-l text-primary-700">
                    Ruko graha kota CC-31, Jl. Raya Sungon No.28, Sungon, Suko,
                    Kec. Sidoarjo, Kabupaten Sidoarjo, Jawa Timur 61224
                </p>
                <div className="aspect-20x9 relative w-full overflow-hidden rounded-lg shadow-lg">
                    <iframe
